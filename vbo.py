...
class VBO_interface(ABC):
    ...
    # Define an abstract method for destroying the VBO
    @abstractmethod
    def destroy(self):
        raise NotImplementedError
...
class skybox_VBO(VBO_interface):
    ...
    def __init__(self, app):
        self.app = app
        self.vbo = self.g_vbo()  # Retrieve the OpenGL VBO handle

    # Implement the destroy method to release the VBO
    def destroy(self):
        self.vbo.release()

    # Static method to generate geometry data from vertex and index arrays
    @staticmethod
    def g_data(vert, ind):
...
class cube_VBO(VBO_interface):
    ...
    @staticmethod
    def g_data(vert,ind):
        # Static method to convert vertex and index data into numpy array
